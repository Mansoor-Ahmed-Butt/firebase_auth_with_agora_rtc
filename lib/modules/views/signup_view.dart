                ...
                child: Obx(
                  () => Column(
                    ...
                    children: [
                      ...
                      Text('Sign up to get started', style: TextStyle(fontSize: 16, color: Colors.white.withValues(alpha: 0.9))),
                      const SizedBox(height: 40),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('Already have an account? ', style: TextStyle(color: Colors.white.withValues(alpha: 0.9))),
                          GestureDetector(
                            onTap: () {
                              context.go('/login');
                            },
