                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Sign in to continue', style: TextStyle(fontSize: 16, color: Colors.white.withValues(alpha: 0.9))),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Don't have an account? ", style: TextStyle(color: Colors.white.withValues(alpha: 0.9))),
                          GestureDetector(
                            onTap: () {
                              context.go('/signup');
                              // Navigator.push(
